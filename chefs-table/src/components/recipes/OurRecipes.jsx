...
function OurRecipes({recipes, handleWantToCook, wantToCook, currentlyCooking, handleCurrentlyCooking}) {
  return (
    <div>
      ...
      <div className="our-recipes flex flex-col lg:flex-row gap-6 justify-center items-start">
        ...
        <div className="w-full lg:w-2/5 rounded-lg border-1 border-gray-200 py-8 h-fit">
